    ...
    <>
        ...
        <div className="h-[21rem] gap-[2.75rem] flex justify-center flex-col items-center">
          ...
          <div>
            <p className="text-zenno-aboutb2 font-medium text-[0.93rem] leading-[1.40rem] text-justify w-[31.125rem]">
              ...
              where fellow readers could find their next literary obsession. We wanted to
              make book recommendations personal and exciting, so we developed
              cutting-edge technology that analyzes your preference and suggests books
              tailored just for you.{' '}
            </p>{' '}
            <p className="text-zenno-aboutb2 font-medium text-[0.93rem] leading-[1.40rem] text-justify w-[31.125rem] mt-[2rem]">
              Our vibrant community of book lovers adds an extra layer of magic to Zeeno.
              Together, we’re on a mission to bring the joy of reading to everyone and
              create a world where books come to life. Join us in this incredible journey
              and let’s dive into a world of captivating stories.
            </p>
          </div>
        </div>
        <div>
      ...
      <div className="h-[23.56rem] gap-[5.625rem] flex items-center justify-center px-[5.06rem] mt-[6.8rem]">
        <div className="h-[21rem] gap-[2.75rem] flex justify-center flex-col items-center">
          ...
          <div>
            <p className="text-zenno-aboutb2 font-medium text-[0.93rem] leading-[1.40rem] text-justify w-[31.125rem]">
              Our mission is to make book recommendations a delightful adventure for book
              lovers like you! W e believe everyone deserves to discover the perfect book
              that sparks their imagination and leaves them wanting more.{' '}
            </p>{' '}
            <p className="text-zenno-aboutb2 font-medium text-[0.93rem] leading-[1.40rem] text-justify w-[31.125rem] mt-[2rem]">
              Our dedicated team works tirelessly to curate a diverse collection of books
              and use innovative technology to match them with your unique taste and
              interests. We’re here to empower you tto explore new genres, discover hidden
              gems and connect with fellow readers who share your passion.
            </p>
          </div>
        </div>
        <div>
      ...
      <div className="h-[23.56rem] gap-[5.625rem] flex items-center justify-center px-[5.06rem] mt-[6.8rem]">
        ...
        <div className="h-[21rem] gap-[2.75rem] flex justify-center flex-col items-center">
          ...
          <div>
            ...
            <p className="text-zenno-aboutb2 font-medium text-[0.93rem] leading-[1.40rem] text-justify w-[31.125rem] mt-[2rem]">
              You have the ability to take direct control of your journey, discovering new
              genres, authors and hidden gems that truly resonate with you. It’s all about
              giving you the power to curate your own reading adventure.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="absolute top-0 flex flex-col justify-center items-center">
          <div className="h-[622px]">
            ...
            <p className="w-[30.43rem] h-[24.43rem] text-[1.25rem] font-medium text-justify mt-[2rem] text-zenno-1white">
              ...
              captivating stories, it’s a one-stop for all your book recommendation needs.
              Zeeno is your gateway to a world of immerse reading experiences, creating a
              sophisticated and comprehensive book recommendation website that caters to
              the diverse taste of readers. Aims to connect readers with their next great
              book, and our goal is to create a platform that inspires, engages and
              enriches the reading journey of every user.
            </p>
        ...
        <div className="flex flex-col items-center gap-[4.125rem] w-[44.62rem] h-[16.06rem] mb-[8.5rem]">
          ...
          <div className="w-[43.62rem]">
            ...
            <p className="text-zenno-black text-[1.25rem] font-medium leading-[1.87rem] mt-[2rem]">
              You can use comprehensive search ideas to narrow down your research and and
              content with ease.
            </p>
          </div>
        </div>
