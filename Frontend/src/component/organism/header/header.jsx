...
const Header = () => {
  return (
    <>
      <div className="md:hidden 2xl:flex items-center justify-center 2xl-max:flex 2xl-max:justify-center 2xl-max:items-center ">
      ...
      {/* mobile */}
      <div className="2xl:hidden md:flex items-center justify-center 2xl-max:hidden">
