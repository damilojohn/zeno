...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_reading_history_updated_at'), 'reading_history', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_topic_recommendations_created_at'), 'topic_recommendations', ['created_at'], unique=False)
    op.create_index(op.f('ix_topic_recommendations_id'), 'topic_recommendations', ['id'], unique=False)
    op.create_index(op.f('ix_topic_recommendations_topic'), 'topic_recommendations', ['topic'], unique=False)
    op.create_index(op.f('ix_topic_recommendations_updated_at'), 'topic_recommendations', ['updated_at'], unique=False)
    op.create_index(op.f('ix_topic_recommendations_user_id'), 'topic_recommendations', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_user_interests_created_at'), 'user_interests', ['created_at'], unique=False)
    op.create_index(op.f('ix_user_interests_id'), 'user_interests', ['id'], unique=False)
    op.create_index(op.f('ix_user_interests_topic'), 'user_interests', ['topic'], unique=False)
    op.create_index(op.f('ix_user_interests_updated_at'), 'user_interests', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_book_recommendations_updated_at'), 'book_recommendations', ['updated_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_book_recommendations_updated_at'), table_name='book_recommendations')
    ...
    op.drop_index(op.f('ix_topic_recommendations_user_id'), table_name='topic_recommendations')
    op.drop_index(op.f('ix_topic_recommendations_updated_at'), table_name='topic_recommendations')
    op.drop_index(op.f('ix_topic_recommendations_topic'), table_name='topic_recommendations')
    op.drop_index(op.f('ix_topic_recommendations_id'), table_name='topic_recommendations')
    op.drop_index(op.f('ix_topic_recommendations_created_at'), table_name='topic_recommendations')
